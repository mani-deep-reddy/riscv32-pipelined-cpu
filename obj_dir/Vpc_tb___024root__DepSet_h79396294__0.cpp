...
VL_INLINE_OPT void Vpc_tb___024root___nba_sequent__TOP__0(Vpc_tb___024root* vlSelf) {
    ...
    // Body
    vlSelf->pc_tb__DOT__pc = ((IData)(vlSelf->pc_tb__DOT__reset)
                               ? 0U : ((IData)(vlSelf->pc_tb__DOT__pc_write)
                                        ? vlSelf->pc_tb__DOT__pc_next
                                        : vlSelf->pc_tb__DOT__pc));
}
...
void Vpc_tb___024root___timing_resume(Vpc_tb___024root* vlSelf) {
    ...
    if ((4ULL & vlSelf->__VactTriggered.word(0U))) {
        vlSelf->__VtrigSched_h00f6b3bc__0.resume("@(posedge pc_tb.clk)");
    }
...
void Vpc_tb___024root___timing_commit(Vpc_tb___024root* vlSelf) {
    ...
    // Body
    if ((! (4ULL & vlSelf->__VactTriggered.word(0U)))) {
        vlSelf->__VtrigSched_h00f6b3bc__0.commit("@(posedge pc_tb.clk)");
    }
}
...
#endif
            VL_FATAL_MT("tb/block_tests/fetch/pc_tb.sv", 3, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("tb/block_tests/fetch/pc_tb.sv", 3, "", "Active region did not converge.");
            }
